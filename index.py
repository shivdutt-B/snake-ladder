...
redpiece = pygame.image.load("assets/redpiece.png")
yellowpiece = pygame.image.load("assets/yellowpiece.png")
greenpiece = pygame.image.load("assets/greenpiece.png")
bluepiece = pygame.image.load("assets/bluepiece.png")
...
def main():
    ...
    while menu:
        ...
        # Fill with white background instead of using the menubg image
        GD.fill(white)
...
def play(b):
    ...
    if b6 == 7:
        options()
    # Fill with white background instead of using the playbg2 image
    GD.fill(white)
    GD.blit(board, (w/2-250, h/2-250))
    xcr = xcy = xcg = xcb = 406-25
    ycr = ycy = ycg = ycb = 606-25
    GD.blit(redpiece, (xcy, ycy))
    if 5 > b > 1 or b == 21:
        GD.blit(yellowpiece, (xcy, ycy))

    if 5 > b > 2 or b == 21:
        GD.blit(greenpiece, (xcg, ycg))

    if 5 > b > 2:
        GD.blit(bluepiece, (xcb, ycb))
    p1 = "Player 1"
    p1score = 0
    if b == 21:
        p2 = "Computer"
    ...
    while True:
        ...
        GD.blit(redpiece, (xcr, ycr))
        if 5 > b > 1 or b == 21:
            GD.blit(yellowpiece, (xcy+2, ycy))

        if 5 > b > 2:
            GD.blit(greenpiece, (xcg+4, ycg))

        if 5 > b > 3:
            GD.blit(bluepiece, (xcb+6, ycb))
